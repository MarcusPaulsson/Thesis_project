...
def load_llama_model(model_path, ctx_window=6000, n_gpu_layers=-1, verbose=True):
    """
...
if __name__ == "__main__":
    ...
    apps_file_path = os.path.join(main_dir, "data", "ClassEval_data.json")  # Adjust filename and path
    ...
    results_dir = os.path.join(main_dir, "results", "Qwen", "classEval", prompt.PROMPT_TECHNIQUE_SETTING)
