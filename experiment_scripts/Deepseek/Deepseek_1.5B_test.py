...
def run_task_with_local_model(task_prompt):
    ...
    formatted_prompt = f"{task_prompt}"
...
if __name__ == "__main__":
    ...
    task_prompt = "Give me a full implementation of the game battleship with a command line interface. Do not use any external libraries that needs downloading"
